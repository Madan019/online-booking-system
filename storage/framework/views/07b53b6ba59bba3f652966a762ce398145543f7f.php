...
<aside class="aside">
    <div class="aside-content">
        ...
        <nav class="aside-menu">
            <ul>
                <li>
                    <a href="<?php echo e(route('dashboard')); ?>"><i class="fa fa-tachometer" aria-hidden="true"></i> Dashboard</a>
                </li>
                ...
                <ul>
                    <li>
                        ...
                        <ul class="nested-menu">
                            <li>
                                <a href="<?php echo e(route('employees.index')); ?>">All</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('employees.create')); ?>">Create</a>
                            </li>
                        </ul>
                    </li>
                </ul>
            ...
            <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('services', \Illuminate\Support\Facades\Auth::user())): ?>
                <ul>
                    <li>
                        <a href="#" class="toggle-menu">
                        ...
                        <ul class="nested-menu">
                            <li>
                                <a href="<?php echo e(route('services.index')); ?>">All</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('services.create')); ?>">Create</a>
                            </li>
                        </ul>
                    </li>
                </ul>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('employees',\Illuminate\Support\Facades\Auth::user())): ?>
                <ul>
                    <li>
                        ...
                        <ul class="nested-menu">
                            <li>
                                <a href="<?php echo e(route('working-hours.index')); ?>">All</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('working-hours.create')); ?>">Create</a>
                            </li>
                        </ul>
                    </li>
                </ul>
